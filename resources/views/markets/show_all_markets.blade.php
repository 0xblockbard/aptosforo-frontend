            ...
            <div class="w-full mx-auto">
                ...
                <div class="w-full max-w-full mx-auto ml-4 overflow-x-auto no-scrollbar">
                    ...
                    <div class="flex flex-row flex-nowrap space-x-4">
                        ...
                        <button class="flex-none px-4 py-2 text-sm leading-4 font-medium rounded-md shadow-sm text-black bg-teal-50 border border-teal-500 hover:bg-teal-600 hover:border-teal-600 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-200 transition duration-300">
