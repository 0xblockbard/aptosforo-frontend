        ...
        <div class="market_container single_market flex flex-col sm:flex-row w-full">
            ...
            <div class="flex flex-col w-full sm:w-1/3 sm:px-6 py-2 ">
                ...
                <div id="market_actions_card" class="market_actions_card rounded-md shadow-lg border border-gray-300 px-6 pt-4 pb-6"> 
                    ...
                    <div class="flex flex-row mt-2 justify-between border-b pt-2 pb-4 border-gray-200"> 
                        <div class="flex space-x-4 text-md">
                            <div class="font-semibold hover:cursor-pointer">Buy</div>
                            <div class="hover:cursor-pointer">Sell</div>
                        </div>
                        <div class="flex text-md font-semibold">
                            <div class="uppercase hover:cursor-pointer">AMM</div>
                        </div>

                    </div>

                    <h3 class="text-md font-medium mt-6 mb-2">Outcome</h3>
                    ...
                    <div class="flex flex-col mt-4">
                        <h3 class="text-md font-medium mt-2 mb-1">Amount</h3>
                        ...
                        <button class="submit_button px-2 py-4 mt-6 mr-0.5">
                            <span>Submit</span>
                        </button>
                    </div>
                </div>
