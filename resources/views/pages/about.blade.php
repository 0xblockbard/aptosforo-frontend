    ...
    <div class="bg-white overflow-hidden w-full">
        <div class="relative max-w-7xl mx-auto py-8 sm:py-16 px-4 sm:px-6 lg:px-8">
            ...
            <div class="mx-auto text-base max-w-prose lg:grid lg:grid-cols-2 lg:gap-8 lg:max-w-none">
                <div>
                    <h2 class="text-base text-gray-700 font-semibold tracking-wide uppercase">An Aptos Code Collision Hackathon project</h2>
            ...
            <div class="mt-8 lg:grid lg:grid-cols-2 lg:gap-8">
                ...
                <div class="mt-8 lg:mt-0">
                    <div class="text-base max-w-prose mx-auto lg:max-w-none">
                        <p class="text-lg text-gray-500">A decentralised crowdfunding platform for the community powered by the Aptos blockchain.</p>
                    </div>
                    <div class="mt-5 prose prose-teal text-gray-500 mx-auto lg:max-w-none lg:row-start-1 lg:col-start-1 text-justify pr-5">
                        <p>AptosCrowd DAO is a MVP prototype of a crowdfunding smart contract comprising both the Flexible (Keep-It-All) crowdfunding model and the Fixed (All-Or-Nothing) crowdfunding model.</p>
                        ...
                        <p>In the Aptos ecosystem, a decentralised crowdfunding platform will also serve to foster a shared community spirit together in support of new and exciting projects, NFT and otherwise.</p>
                        <p>Through crowdfunding, project creators and developers (e.g. for a large-scale NFT avatar project) can lower their risk and gauge the market or community's response to their project based on Aptos raised.</p>
                        ...
                        <p>With the implementation of AptosCrowd DAO, I hope that this would lead to a higher number of successful projects started on the Aptos blockchain driven by an ever-growing supportive community.</p>

                        <h3>Goals</h3>
                        <p>For this MVP, my focus is to first establish a proof-of-concept for decentralised crowdfunding on the Aptos blockchain and establish an outline of the AptosCrowd DAO white paper.</p>
                        <p>This will help solidify the foundations of the project and serve to attract members to be part of the DAO.</p>
                        <p>Thereafter, the focus will shift to onboard potential crowdfunding projects in the Aptos ecosystem and further develop the platform to phase 2 and beyond.</p>

                        <h3>Governance Mechanism</h3>
                        <p>The AptosCrowd DAO will allow members to decide the focus and direction of the decentralised crowdfunding platform.</p>
                        ...
                        <p>AptosCrowd DAO will progressively move from a one-man-operation to become primarily community-led to collectively decide on new crowdfunding projects, manage members, and distribute any internal funds raised.</p>
                        ...
                        <p>Similar to Indiegogo, AptosCrowd project owners have the flexibility to decide whether their crowdfunding project will be based on either the Flexible (KIA) model or the Fixed (AON) model.</p>
                        ...
                        <p>Users can connect their wallets and support the sample project by pledging Aptos - for development purposes, a testnet wallet is used behind the scenes to send any apt (no matter which wallet has been connected).</p>
                        ...
                        <h3>Who Made This</h3>
                        <p>AptosCrowd is designed and built by <a href="https://twitter.com/0xblockbard" target="_blank">@0xblockbard</a>.
